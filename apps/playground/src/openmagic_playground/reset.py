"""Guarded reset for explicitly marked synthetic playground databases."""
...
import psycopg
from example_insurance.migrations import apply_migrations_on
...
def reset_synthetic_deployment(database_url: str) -> None:
    """Atomically reset only a preflight-approved synthetic deployment."""
